    ...
    return(
        <>
            <div className="flex gap-2">
                <input type="text" className="focus:outline-none border-primary" value={photoLink} onChange={ev=>setPhotoLink(ev.target.value)} placeholder="Add using a link ....jpg"/>
            ...
            <label className="flex gap-1 items-center justify-center border cursor-pointer bg-gray-300 text-black rounded-2xl p-2 h-32">
